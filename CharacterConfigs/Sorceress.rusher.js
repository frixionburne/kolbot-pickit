...
function LoadConfig() {
	...
	*/
	...
	Config.QuitList = ["frixlsI", "frixlsII", "frixlsIII", "frixlsIV"]; // List of character names to quit with. Example: Config.QuitList = ["MySorc", "MyDin"];
	...
	// Config.Recipes.push([Recipe.Unique.Armor.ToExceptional, "Spiked Shield", Roll.NonEth]); // Upgrade Swordback to Exceptional
	// Config.Recipes.push([Recipe.Unique.Armor.ToExceptional, "Spiked Shield", Roll.Eth]); // Upgrade Swordback to Exceptional
	// Config.Recipes.push([Recipe.Unique.Armor.ToElite, "Barbed Shield", Roll.NonEth]); // Upgrade Swordback to Elite
	// Config.Recipes.push([Recipe.Unique.Armor.ToElite, "Barbed Shield", Roll.Eth]); // Upgrade Swordback to Elite

	// Config.Recipes.push([Recipe.Unique.Armor.ToElite, "Serpentskin Armor", Roll.NonEth]); // Upgrade Vipermagi to Elite

	// Config.Recipes.push([Recipe.Unique.Armor.ToElite, "Round Shield", Roll.NonEth]); // Upgrade Mosers to Elite
	...
	Config.AttackSkill[1] = 59; // Primary skill to bosses. (Blizzard)
	Config.AttackSkill[2] = 45; // Primary untimed skill to bosses. Keep at -1 if Config.AttackSkill[1] is untimed skill. (Ice Blast)
	Config.AttackSkill[3] = 59; // Primary skill to others. (Blizzard)
	Config.AttackSkill[4] = 45; // Primary untimed skill to bosses. Keep at -1 if Config.AttackSkill[3] is untimed skill. (Ice Blast)
